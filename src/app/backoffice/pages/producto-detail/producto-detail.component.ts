...
export class ProductoDetailComponent  implements OnInit {
  ...
  product = new FormGroup({
    ...
    enlacePermanente: new FormControl<string>(''),
  ...
  onPriceInput(event: any): void {
    ...
    // Solo lo seteamos si el valor es un número válido
  ...
  async save() {
    ...
    console.log('Form errors:', this.product.errors);
    console.log('Controls:', this.product.controls);
    console.log('VALIDA?', this.product.valid);
    console.log('TOUCHED?', this.product.touched);

    for (let controlName in this.product.controls) {
  const control = this.product.get(controlName);
  console.log(`${controlName} - valid: ${control.valid} - value:`, control.value);
}
    console.log('this.categoria.valid -> ', this.product.valid);
